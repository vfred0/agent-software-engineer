...
description: Generate technical documentation with PlantUML diagrams and AsciiDoc. Creates UML class diagrams, use cases, activity diagrams, state diagrams, and comprehensive AsciiDoc index following internal styling standards.
---
